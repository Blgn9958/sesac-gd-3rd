...
// switch
// switch의 괄호 안과 조건으로 비교식이 들어갈 수 없음
/* 
1. 변수 x의 값과 첫 번째 case문의 값 3을 비교
2. 두 값이 동일하다면 :(콜론) 뒤의 코드가 실행
3. break문을 통해 해당 스코프에서 빠져나움
...
//     console.log("B")
// 이런 작성 안좋다
// 이럴 때 점수를 10으로 나눈 묷을 찾아와 number로 전달, case 값도 변경
