...
console.log("---------"); // false
console.log(1 === 1); // true
console.log(1 === 2); // false -> 숫자 1과 문자 1은 다른 타입
console.log(1 === "1"); // false -> 숫자 1과 숫자 2는 같지 않는다! -> false
console.log(1 !== 2); // -> 숫자 1과 숫자 2는 같지 않는다! -> false
...
console.log("원하는 텍스트 같이 출력");

console.log(a, "원하는 텍스트 같이 출력", a);

console.log(aa, "쉼표"); // 자동으로 뜨어쓰기 됨
console.log(aa + "+연산자"); // 전부 연결해서 출력됨

// "안녕 나는 레일라"
const name = "레일라";
console.log("안년 나는", name, "양");
console.log("안년 나는" + name, "양");
